...
class ModalSelectWorkBudget extends Component {
  constructor(props) {
    super(props);
  ...
  _handleFileChange(e) {
    ...
    reader.onloadend = () => {
      let newFileName = this.props.rowSelected.name
        .split(" ")
        .join("");
...
ModalSelectWorkBudget.propTypes = {
...
export default ModalSelectWorkBudget;
