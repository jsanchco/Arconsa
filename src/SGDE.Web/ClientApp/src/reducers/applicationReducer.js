...
const applicationReducer = (state = INITIAL_STATE.application, action) => {
  switch (action.type) {
    ...
    case ACTIONS.Types.SET_CURRENTPAGE_INVOICES: {
      return {
        ...state,
        currentPageInvoices: action.payload,
      };
    }

    case ACTIONS.Types.SET_CURRENTSEARCH_INVOICES: {
      return {
        ...state,
        currentSearchInvoices: action.payload,
      };
    }
