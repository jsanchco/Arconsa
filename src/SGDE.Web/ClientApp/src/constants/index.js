...
export const WORKERSHIRING = "api/WorkersHiring/enterprise";
...
export const DASHBOARD_COSTANDINCOMES = "api/dashboard/enterprise/{0}/costsandincomes";
export const DASHBOARD_WORKSOPENEDANDCLOSED = "api/dashboard/enterprise/{0}/worksopenedandclosed";
