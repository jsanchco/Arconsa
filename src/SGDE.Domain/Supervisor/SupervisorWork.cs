namespace SGDE.Domain.Supervisor
{
    ...
    {
        public QueryResult<WorkViewModel> GetAllWork(int skip = 0, int take = 0, int enterpriseId = 0, string filter = null, int clientId = 0, bool showCloseWorks = true)
        {
            var queryResult = _workRepository.GetAll(skip, take, enterpriseId, filter, clientId, showCloseWorks);
